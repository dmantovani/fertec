	...
	<div class="home-content" style="margin-top:0px; padding-top:20px;">
		...
		<div class="tab-content" id="adm_form">
		  <div class="tab-pane active" id="tab1">
			 <form method="post" action="<?php echo base_url()?>condiciones_categorias/save/">
	   ...
	   <a href="<?php echo base_url()?>condiciones_categorias/"><div class="btn btn-default btn-sm pull-right" style="margin-right:8px;">CANCELAR</div></a>
	</div>
</div>
<br style="clear:both;"/>