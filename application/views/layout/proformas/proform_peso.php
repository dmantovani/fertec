...
<html>
<head>
	<title>Proforma | <?php echo $user[0]->nombre ?></title>
...
<body style="width: 800px;
    ...
    <div style="margin:0;padding:15px;background:#ea2131;">
   	...
   	<div style="width:100%;padding:15px;">
   		...
   		<div style="width:49%;display:inline-block;margin:0;vertical-align:middle;float:right;">
   			<p style="width:100%;color:#000;font-family:'Arial';margin:0;padding:3px 5px;">Cotización / Proforma</p>
    ...
    <table class="tg" style="padding:15px;width:100%;">
        <tr style="border-bottom:1px solid #000;">
          ...
          <th class="tg-0pky" style="font-size:10px;text-align:left;">IVA Incluído</th>
              ...
              <td class="tg-0pky" style="font-size:10px;vertical-align:top;border-top:1px solid #000;padding:10px 0;">$ <?php echo number_format($producto->precio*$precio) ?></td>
                ...
                <?php foreach($this->page_model->get_opcionales_presupuesto_id($user[0]->id, $producto->{'id'},$producto->{'id_producto_session'}) as $opcional):
                  $suma_opcionales[$key_producto] += $opcional->{'precio'}*$precio;
                  ?>
				  <tr>
    ...
    <?php $suma_total[$key_producto] = $producto->{'precio'}*$precio + $suma_opcionales[$key_producto];
    ...
    <div style="width:100%;text-align:right;padding:15px;">
      <span style="font-size:17px;line-height:2">Total: $ <?php echo number_format($total_final) ?></span><br>
    ...
    <div style="width:100%;text-align:left;padding:15px;padding-top:0px">
      ...
      <?php $descuento[$key_producto] = 0;?>
        ...
        $descuento[$keycondiciones]= $condiciones->{'descuento'}*$precio ?>
          ...
          ?>
            ...
            <span style="font-size:10px;">> <?php echo $condiciones->{'item'} ?> - % <?php echo $condiciones->{'descuento'}; ?></span> <b> $ <?=$tot[$keycondiciones]?></b></p>
        <?php endforeach; ?>
    </div>
