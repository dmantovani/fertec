...
class Usuarios extends CI_Controller {
	...
	public function index()
	{
	    ...
	    $this->template->write_view('content', 'layout/usuarios/list', $data, TRUE); 
	...
	public function add(){
		...
		$this->template->write_view('content', 'layout/usuarios/add', $data, TRUE); 
		$this->template->render();
	}
	...
	public function edit(){
		...
		$this->template->write_view('content', 'layout/usuarios/edit', $data, TRUE); 
		$this->template->render();
	}
