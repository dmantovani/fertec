	...
	<div class="home-content" style="margin-top:0px; padding-top:20px;">
		...
		<div class="tab-content" id="adm_form">
		  <div class="tab-pane active" id="tab1">
			 <form method="post" action="<?php echo base_url()?>vendedores/update/<?php echo $info[0]->{'id'}?>/">
				<div class="td-input">
					<b>Vendedor:</b><br>
					<input type="text" name="vendedor" id="vendedor" value="<?php echo $info[0]->{'vendedor'};?>">
				</div>
