        ...
        <div class="tab-content" id="adm_form">
            <div class="tab-pane active" id="tab1">
                <form method="post" action="<?php echo base_url()?>categorias/update/<?php echo $info[0]->{'id'}?>/">
                    <div class="td-input">
                        <b>Nombre:</b><br>
                        <input type="text" name="nombre" id="nombre" value="<?php echo $info[0]->{'categoria'};?>">
                    </div>
                    <div class="td-input">
                    <b>Marca<br>
                    <select name="marca_id">
                        ...
                        <?php foreach($marcas as $marca): ?>
                            <option value="<?=$marca->id?>" <?php if($info[0]->{'marca_id'} == $marca->id): echo "selected"; endif; ?>><?=$marca->nombre?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                </form>
