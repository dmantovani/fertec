    ...
    <div class="home-content" style="margin-top:0px; padding-top:20px;">
        ...
        <div class="tab-content" id="adm_form">
            <div class="tab-pane active" id="tab1">
                <form method="post" action="<?php echo base_url()?>condiciones/update/<?php echo $info[0]->{'id'}?>/">
                    
                    <div class="td-input">
                        <b>Nombre:</b><br>
                        <input type="text" name="item" id="item" value="<?php echo $info[0]->{'item'};?>">
                    </div>
                    
                    <div class="td-input">
                        <b>% Descuento:</b><br>
                        <input type="text" name="descuento" id="descuento" value="<?php echo $info[0]->{'descuento'};?>">
                    </div>
                    ...
                    <select name="categoria_id">
                        ...
                        <?php foreach($categorias as $marca): ?>
                            <option value="<?=$marca->id?>" <?php if($info[0]->{'categoria_id'} == $marca->id): echo "selected"; endif; ?>><?=$marca->categoria?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                </form>
