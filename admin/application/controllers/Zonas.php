...
class Zonas extends CI_Controller {
	...
	public function index()
	{
		...
		$info =  $this->page_model->get_usuarios_zonas();
		$data['info']=$info;
	    ...
	    $this->template->write_view('content', 'layout/zonas/list', $data, TRUE); 
	...
	public function add(){
		...
		$data['concesionarios']=$info;
		
		$this->template->write_view('content', 'layout/zonas/add', $data, TRUE); 
		$this->template->render();
	}
	...
	public function save(){
		if (isset($this->session->userdata['logged_in'])) {
			...
			$result = $this->page_model->checkuser($_POST['usuario'], $_POST['email']);
			if ($result == TRUE) {
				$this->template->set_template('template');
				...
				foreach($_POST['id_concesionario'] as $key => $value)
				{
					$data_ids = array(
						'id_usuario' => $id_usuario,
						'id_concesionario' => $value
					);

					$this->db->insert('zonas', $data_ids);
				}
	...
	public function edit(){
		...
		$this->template->write_view('content', 'layout/zonas/edit', $data, TRUE); 
		$this->template->render();
	}
