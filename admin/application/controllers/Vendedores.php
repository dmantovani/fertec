...
class Vendedores extends CI_Controller {
	...
	public function index()
	{
	    ...
	    $this->template->write_view('content', 'layout/vendedores/list', $data, TRUE); 
	...
	public function add(){
		...
		$this->template->write_view('content', 'layout/vendedores/add', $data, TRUE); 
		$this->template->render();
	}
	...
	public function save(){
		...
		$this->page_model->insert_vendedor($data);
		redirect('vendedores/');
	...
	public function update(){
		if (isset($this->session->userdata['logged_in'])) {
			...
			$this->page_model->update_vendedor($data);
			redirect('vendedores/');
		}else{
			redirect('login/');
		}
	...
	public function remove(){
		if (isset($this->session->userdata['logged_in'])) {
			$this->page_model->remove_vendedores();
			redirect('vendedores/');
		}else{
			redirect('login/');
		}
	...
	public function edit(){
		...
		$CI =& get_instance();
		$info =  $this->page_model->get_vendedor_id($this->uri->segment(3));		
		$data['info']=$info;
		
		$this->template->write_view('content', 'layout/vendedores/edit', $data, TRUE); 
		$this->template->render();
	}
