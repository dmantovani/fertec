						...
						foreach ( $info as $fila ){
						   ...
						   if($fila->{"user_name"} != "admin"):
							...
							$html.='<tr>
								...
								<td>'.$fila->{'name'}.'</td>
								<td>'.$fila->{'lastname'}.'</td>
								<td align="center"><a href="'.base_url().'usuarios/edit/'.$fila->{'id'}.'/"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></td>
								<td align="center"><a href="#" data-href="'.base_url().'usuarios/remove/'.$fila->{'id'}.'/" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></td>
							</tr>';
